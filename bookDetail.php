    ...
    <div class="span3">
      <div class="well sidebar-nav">
        <ul class="nav nav-list" id="admin_left_categorys">
          ...
          <li >
            id:
            <?php echo $book->bookId;?></li>
          <li >
            名称:
            <?php echo $book->name;?></li>
          <li >
            编号:
            <?php echo $book->sunccoNo;?></li>
          <li >
            ISBN:
            <?php echo $book->ISBN;?></li>
          <li >
            价格:
            <?php echo $book->price;?></li>
			 属地:
            <?php echo $book->place;?></li>
          <?php
                  $bookStatuStr = "";
                  if ($book->
          status == 0) {
          ...
          <li >
            状态:
            <?php echo $bookStatuStr;?></li>
          <li >
            借阅次数:
            <?php echo $book->count;?></li>
        </ul>
      </div>
    </div>
